...
QUARK_API_AK = os.getenv("QUARK_API_AK")
QUARK_API_SK = os.getenv("QUARK_API_SK")
QUARK_API_BASE_URL = os.getenv("QUARK_API_BASE_URL")
QUARK_API_PAGE_SIZE = os.getenv("QUARK_API_PAGE_SIZE")
